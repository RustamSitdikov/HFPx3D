...
double hfp3d::VNorm(il::StaticArray<double, 3> a) {
    // L2 norm of a vector
    double N = 0.0;
...
il::StaticArray<double, 3> hfp3d::normalize(il::StaticArray<double, 3> a) {
...
il::StaticArray<double, 3> hfp3d::cross(il::StaticArray<double, 3> a,
                                        il::StaticArray<double, 3> b) {
...
il::StaticArray2D<double, 3, 3> hfp3d::El_LB_RT
    ...
    il::StaticArray<double, 3> a1{0.0}, a2{0.0}, a3{0.0},
...
il::StaticArray<std::complex<double>, 3> hfp3d::El_RT_Tr
        (const il::StaticArray2D<double, 3, 3>& EV,
         const il::StaticArray2D<double, 3, 3>& RM,
         il::io_t, il::StaticArray2D<double, 3, 3>& RMt) {
    // This function calculates the inverse (transposed) rotation tensor
    // of the element's coordinate system and tau-coordinates
...
il::StaticArray2D<std::complex<double>, 2, 2> hfp3d::El_CT
        (const il::StaticArray2D<double, 3, 3>& EV,
         il::io_t, il::StaticArray2D<double, 3, 3>& RM) {
...
hfp3d::el_x_cr hfp3d::El_X_CR
        (const il::StaticArray2D<double, 3, 3>& EV,
         const il::StaticArray<double, 3>& X0,
         const il::StaticArray2D<double, 3, 3>& RMt) {
...
il::StaticArray2D<std::complex<double>, 6, 6> hfp3d::El_SFM_S
        (const il::StaticArray2D<double,3,3>& EV,
    ...
    il::StaticArray2D<std::complex<double>, 2, 2> CT = El_CT(EV, il::io, RT);
...
il::StaticArray2D<std::complex<double>, 6, 6> hfp3d::El_SFM_N
        (const il::StaticArray2D<double, 3, 3>& EV,
...
//il::StaticArray2D<std::complex<double>, 6, 6> hfp3d::El_SFM_C
// (const il::StaticArray2D<double, 3, 3>& EV,
// const il::StaticArray<double,3>& VW
// double beta,
// il::io_t, il::StaticArray2D<double, 3, 3>& RT) {
...
il::StaticArray2D<std::complex<double>, 6, 6> hfp3d::El_Shift_SFM
...
il::StaticArray<il::StaticArray<double, 3>, 6> hfp3d::El_CP_S
...
il::StaticArray<il::StaticArray<double, 3>, 6> hfp3d::El_CP_N
        (const il::StaticArray2D<double, 3, 3>& EV,
         const il::StaticArray<double,3>& VW,
         double beta) {
    // This function calculates the coordinates
