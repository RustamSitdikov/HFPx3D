...
class H_Int: public Kernel_Integration {
public:
// General case (h!=0, collocation point projected into or outside the element)

    inline il::StaticArray3D<std::complex<double>, 6, 3, 9> S11_22(double nu, std::complex<double> eix, double h, std::complex<double> d) {
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 9> S11_22_12(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 9> S13_23(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
...
//  std::complex<double> D3mh1 = 3.0*D2-h2;
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 9> S33(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
...
// Special case (reduced summation, collocation point projected onto the element contour) - additional terms
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 5> S11_22_red(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 5> S11_22_12_red(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 5> S13_23_red(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 3, 5> S33_red(double nu, std::complex<double> eix, double h, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
...
// Limit case (h==0, plane) - all stress components
    ...
    inline il::StaticArray3D<std::complex<double>, 6, 4, 3> SijLim(double nu, std::complex<double> eix, std::complex<double> d) {
        const std::complex<double> I(0.0,1.0);
        ...
        for (int j = 0; j < C.size(0); ++j) {
            ...
            C(j, 1, 2) = C1m2*V2[j];
            P1 = 0.25*C2m1*V1[j]; P2 = 0.5*nu*V2[j];
            C(j, 2, 0) = P1 + P2;
            C(j, 2, 1) = I*(P1 - P2);
            C(j, 3, 2) = V1[j];
        }
...
//il::StaticArray3D<std::complex<double>, 6, 3, 9> S11_22H(double, std::complex<double>, double, std::complex<double>);
//il::StaticArray3D<std::complex<double>, 6, 3, 5> S11_22H_red(double, std::complex<double>, double, std::complex<double>);
//il::StaticArray3D<std::complex<double>, 6, 3, 9> S11_22_12H(double, std::complex<double>, double, std::complex<double>);
//il::StaticArray3D<std::complex<double>, 6, 3, 5> S11_22_12H_red(double, std::complex<double>, double, std::complex<double>);
//il::StaticArray3D<std::complex<double>, 6, 3, 9> S13_23H(double, std::complex<double>, double, std::complex<double>);
