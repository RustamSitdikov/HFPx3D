...
void load_mesh_from_numpy_32(const std::string &src_dir,
                             const std::string &conn_f_name,
                             const std::string &node_f_name, bool is_matlab,
                             il::io_t, Mesh_Geom_T &mesh);

// overload for il::String
void load_mesh_from_numpy_32(const il::String &src_dir,
                             const il::String &conn_f_name,
                             const il::String &node_f_name, bool is_matlab,
                             il::io_t, Mesh_Geom_T &mesh);

void load_mesh_from_numpy_64(const std::string &src_dir,
                             const std::string &conn_f_name,
                             const std::string &node_f_name, bool is_matlab,
                             il::io_t, Mesh_Geom_T &mesh);

// overload for il::String
void load_mesh_from_numpy_64(const il::String &src_dir,
                             const il::String &conn_f_name,
                             const il::String &node_f_name, bool is_matlab,
                             il::io_t, Mesh_Geom_T &mesh);

void load_mesh_from_csv(const std::string &src_dir,
                        const std::string &conn_f_name,
                        const std::string &node_f_name, bool is_matlab,
                        il::io_t, Mesh_Geom_T &mesh);

// overload for il::String
void load_mesh_from_csv(const il::String &src_dir,
                        const il::String &conn_f_name,
                        const il::String &node_f_name, bool is_matlab, il::io_t,
                        Mesh_Geom_T &mesh);

template <typename T>
void save_data_to_csv(const il::Array<T> &vector, const std::string &trg_dir,
...
void save_data_to_csv(const il::StaticArray<T, m> &vector,
...
template <typename T>
void save_data_to_csv(const il::Array2D<T> &matrix, const std::string &trg_dir,
                      const std::string &of_name) {
  std::string f_path = trg_dir + of_name;
  const char *format;
  if (sizeof(T) == sizeof(std::complex<double>)) {
...
// overload for il::String
template <typename T>
void save_data_to_csv(const il::Array2D<T> &matrix, const il::String &trg_dir,
...
void save_data_to_csv(const il::StaticArray2D<T, m, n> &matrix,
                      const std::string &trg_dir, const std::string &of_name) {
  std::string f_path = trg_dir + of_name;
  const char *format;
  if (sizeof(T) == sizeof(std::complex<double>)) {
