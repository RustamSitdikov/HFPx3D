...
// General case (h!=0, collocation point projected into or outside the element)
    ...
    il::StaticArray4D<std::complex<double>, 6, 4, 3, 9> s_ij_gen_h
        ...
        std::complex<double> c_8_3i_tan = 8.0 + 3.0 * I * tan_x;
        ...
        c_array(1, 0, 0, 1) = I * c_array(1, 0, 1, 1);
        p1 = 0.1 * (d_2 * (7.0 + 2.0 * I * tan_x) + 16.0 * h2 * tcos_x) * e_2;
        p2 = c_7_5nu / 60.0 * d_2 * tan_x;
        c_array(1, 0, 0, 2) = -(I * p1 + p2) * h;
        c_array(1, 0, 1, 2) = -(p1 + I * p2) * h;
        p1 = (d_2 * h2 * (0.4 + 0.11875 * I * tan_x) +
              0.09375 * I * d_4 * tan_x + 0.4 * h4 * tcos_x) * e_2;
        p2 = (-0.05625 * d_2 + 0.11875 * h2) * d_2 * tan_x;
        c_array(1, 0, 0, 3) = (I * p1 + p2) * h;
        c_array(1, 0, 1, 3) = (p1 + I * p2) * h;
        c_array(1, 0, 0, 4) = -c_1_nu * sgh;
        c_array(1, 0, 1, 4) = -I * c_1_nu * sgh;
        c_array(1, 0, 2, 5) = 0.5 * c_1_2nu * e;
        p1 = 0.5 * c_7_2nu * d * e;
        p2 = d_1 * (0.3 + 4.0 / 3.0 * c_2_nu);
        c_array(1, 0, 0, 6) = (p1 + p2) * h;
        c_array(1, 0, 1, 6) = I * (-p1 + p2) * h;
        c_array(1, 0, 2, 6) = 2.0 * c_2_nu * h2 * e;
        p1 = 1.5 * d * e * c_d_3h;
        p2 = d_1 * (1.0 / 6.0 * c_1_2nu * d_2 +
                h2 * (43.0 / 30.0 + c_2_nu / 3.0));
        c_array(1, 0, 0, 7) = (p1 + p2) * h;
        c_array(1, 0, 1, 7) = I * (-p1 + p2) * h;
        c_array(1, 0, 2, 7) = 2.0 * h4 * e;
        p0 = h * c_d_h;
        p1 = 0.15 * d_1 * d_2 - 1.9 / 6.0 * d_1 * h2;
        p2 = 0.25 * d * e * c_d_m3h;
        c_array(1, 0, 0, 8) = -p0 * (p1 + p2);
        c_array(1, 0, 1, 8) = I * p0 * (-p1 + p2);
        ...
        c_array(0, 1, 2, 1) = -I * c_1_m2nu * e_2 * tcos_x;
        c_array(0, 1, 0, 2) = I * d * h * (-0.5 + e_2 * (0.5 + 0.75 * tcos_x));
        c_array(0, 1, 1, 2) = d * h * (0.5 + e_2 * (0.5 + 0.75 * tcos_x));
        c_array(0, 1, 2, 2) = I * h2 * e_2 * tcos_x;
        //p0 = d*h; p1 = ; p2 = ;
        c_array(0, 1, 0, 3) = d * h * 
                (0.28125 * I * h2 - 0.09375 * d_2 * tan_x + 
                        e_2 * (d_2 * (-0.75 * I + 0.28125 * tan_x) -
                                 I * h2 * (0.28125 + 0.375 * tcos_x)));
        c_array(0, 1, 1, 3) = -d * h * 
                (0.28125 * h2 + 0.09375 * I * d_2 * tan_x + 
                        e_2 * (d_2 * (0.75 + 0.28125 * I * tan_x) +
                                 h2 * (0.28125 + 0.375 * tcos_x)));
        p0 = 0.5 * e * h;
        p1 = 3.0 * e_2;
        c_array(0, 1, 0, 6) = p0 * (-p1 + c_9_m4nu);
        c_array(0, 1, 1, 6) = I * p0 * (p1 + c_9_m4nu);
        c_array(0, 1, 2, 6) = -c_1_m2nu * e * d;
        p0 = 1.5 * h * e;
        p2 = c_3d_h * e_2;
        c_array(0, 1, 0, 7) = p0 * (c_d_3h - p2);
        c_array(0, 1, 1, 7) = I * p0 * (c_d_3h + p2);
        c_array(0, 1, 2, 7) = -2.0 * h2 * e * d;
        p0 = 0.25 * h * e * c_d_h;
        p2 = e_2 * (5.0 * d_2 + h2);
        c_array(0, 1, 0, 8) = -p0 * (c_d_m3h + p2);
        c_array(0, 1, 1, 8) = I * p0 * (-c_d_m3h + p2);

        p0 = 0.4 * e_2 * h * tcos_x;
        p2 = 8.0 * e_2 * (-1.0 + tcos_x);
        c_array(1, 1, 0, 1) = I * p0 * (c_8_m5nu + p2);
        c_array(1, 1, 1, 1) = p0 * (-c_8_m5nu + p2);
        c_array(1, 1, 2, 1) = -I * c_1_m2nu * d * e_2 * (0.625 + tcos_x);
        p0 = e_2 * h; //p1 = ; p2 = ;
        c_array(1, 1, 0, 2) = p0 * (d_2 * (-0.7 * I + 0.2 * tan_x) - 
                1.6 * I * h2 * tcos_x - 
                2.0 * e_2 * (0.8 * I * h2 * c_tcos_n1 + 
                        d_2 * (0.1 * tan_x - I * (0.7 + 0.4 * tcos_x))));
        c_array(1, 1, 1, 2) = p0 * (d_2 * (0.7 + 0.2 * I * tan_x) + 
                1.6 * h2 * tcos_x + 
                2.0 * e_2 * (-0.8 * h2 * c_tcos_n1 + 
                        d_2 * (0.7 + 0.1 * I * tan_x + 0.4 * tcos_x)));
        c_array(1, 1, 2, 2) = d * e_2 * 
                (-d_2 * c_1_m2nu * (-0.5 * I + 0.1875 * tan_x) + 
                        I * h2 * (1.1875 + 1.75 * tcos_x - 
                                0.125 * nu * c_3_4tcos));
        //p1 = ; p2 = ;
        c_array(1, 1, 0, 3) = p0 * (d2h2 * (0.4 * I - 0.11875 * tan_x) - 
                0.09375 * d_4 * tan_x + 0.4 * I * h4 * tcos_x + 
                e_2 * (3.0 * d_4 * (-0.4 * I + 0.18125 * tan_x) + 
                        0.4 * I * h4 * c_tcos_n1 + 
                        d2h2 * (0.11875 * tan_x - 0.4 * I * (2.0 + tcos_x))));
        c_array(1, 1, 1, 3) = -p0 * (d2h2 * (0.4 + 0.11875 * I * tan_x) + 
                0.09375 * I * d_4 * tan_x + 0.4 * h4 * tcos_x + 
                e_2 * (3.0 * d_4 * (0.4 + 0.18125 * I * tan_x) - 
                        0.4 * h4 * c_tcos_n1 + 
                        d2h2 * (0.11875 * I * tan_x + 0.4 * (2.0 + tcos_x))));
        c_array(1, 1, 2, 3) = -I * d * e_2 * h2 * 
                (d_2 * (1.5 + 0.5625 * I * tan_x) + 
                        0.1875 * h2 * c_3_4tcos);
        c_array(1, 1, 2, 5) = -0.5 * c_1_m2nu * e_3;
        p0 = d * e * h;
        c_array(1, 1, 0, 6) = -p0 * (4.5 * e_2 - 0.5 * c_9_m4nu);
        c_array(1, 1, 1, 6) = I * p0 * (4.5 * e_2 + 0.5 * c_9_m4nu);
        c_array(1, 1, 2, 6) = -e_3 * (2.0 * c_2_mnu * h2 + 
                3.0 * c_1_m2nu * d_2);
        p1 = 1.5 * d_2 + 4.5 * h2;
        p2 = e_2 * (7.5 * d_2 + 4.5 * h2);
        c_array(1, 1, 0, 7) = p0 * (p1 - p2);
        c_array(1, 1, 1, 7) = I * p0 * (p1 + p2);
        ...
        c_array(1, 1, 1, 8) = I * p0 * (-p1 + p2);
        c_array(1, 1, 2, 8) = -0.5 * e_3 * h2 * c_d_h * (5.0 * d_2 + h2);

        c_array(2, 1, 0, 1) = 3.2 * I * h * e_2 * tcos_x;
        c_array(2, 1, 1, 1) = 3.2 * h * e_2 * tcos_x;
        c_array(2, 1, 2, 1) = 0.625 * I * c_1_m2nu * d;
        p1 = 0.1 * e_2 * 
                (d_2 * (7.0 + 2.0 * I * tan_x) + 16.0 * h2 * tcos_x);
        p2 = I * c_6_m5nu / 30.0 * d_2 * tan_x;
        c_array(2, 1, 0, 2) = -I * h * (p1 - p2);
        ...
        c_array(3, 1, 1, 8) = I * p0 * (p1 + p2);
        c_array(3, 1, 2, 8) = -d * e_3 * h2 * c_d_h * (3.5 * d_2 + 1.5 * h2);

        p1 = 1.25 * nu * d_c;
        c_array(4, 1, 0, 1) = h * (2.875 * d_sin_p - I * p1);
        c_array(4, 1, 1, 1) = h * (p1 - 2.875 * d_cos_p);
        c_array(4, 1, 2, 1) = 0.725 / 3.0 * c_1_m2nu * d_2 * tan_x;
        p0 = 0.0625 * h;
        p1 = 6.0 * nu * I * h2 - c_5_m2nu * d_2 * tan_x;
        p2 = I * (3.0 * c_9_m2nu * I * h2 - 2.0 * nu * d_2 * tan_x);
        ...
        c_array(5, 1, 2, 0) = 6.4 / 3.0 * I * c_1_m2nu * e_2 * tcos_x;
        p0 = d * h;
        p1 = 0.1875 + 1.25 * c_1_mnu;
        p2 = e_2 * (1.4375 + 2.5 * tcos_x);
        c_array(5, 1, 0, 1) = I * p0 * (-p1 + p2);
        c_array(5, 1, 1, 1) = p0 * (p1 + p2);
        c_array(5, 1, 2, 1) = e_2 / 3.0 * 
                (c_1_m2nu * d_2 * (2.6 * I - 0.725 * tan_x) + 
                        12.8 * c_2_mnu * I * h2 * tcos_x);
        //p1 = ; p2 = ;
        c_array(5, 1, 0, 2) = p0 * (0.09375 * I * h2 * c_9_m4nu - 
                0.03125 * d_2 * c_5_m4nu * tan_x + 
                e_2 * (d_2 * (-3.25 / 3.0 * I + 0.46875 * tan_x) - 
                         0.3125 * I * h2 * (2.7 + 4.0 * tcos_x)));
        c_array(5, 1, 1, 2) = -p0 * (0.09375 * h2 * c_9_m4nu + 
                0.03125 * I * d_2 * c_5_m4nu * tan_x + 
                e_2 * (d_2 * (3.25 / 3.0 + 0.46875 * I * tan_x) + 
        ...
        c_array(1, 3, 0, 1) = I * c_array(1, 3, 1, 1);
        p1 = 1.0 / 12.0 * tan_x * d_2;
        p2 = e_2 * h2 * tcos_x;
        c_array(1, 3, 0, 2) = (p1 + I * p2) * h;
        c_array(1, 3, 1, 2) = (I * p1 + p2) * h;
        c_array(1, 3, 0, 3) = -0.25 * d_2 * h3 * tan_x;
        c_array(1, 3, 1, 3) = I * c_array(1, 3, 0, 3);
        c_array(1, 3, 2, 5) = e;
        p2 = 10.0 / 3.0 * d_1;
        c_array(1, 3, 0, 6) = (-d * e - p2) * h;
        c_array(1, 3, 1, 6) = I * (d * e - p2) * h;
        c_array(1, 3, 2, 6) = -4.0 * h2 * e;
        p0 = d_1 * h;
        p1 = (d_2 + 11.0 * h2) / 3.0;
        p2 = 2.0 * e_2 * h2;
        c_array(1, 3, 0, 7) = -(p1 + p2) * p0;
        c_array(1, 3, 1, 7) = -I * (p1 - p2) * p0;
        c_array(1, 3, 2, 7) = -4.0 * h4 * e;
        c_array(1, 3, 0, 8) = -2.0 / 3.0 * h3 * d_1 * c_d_h;
        c_array(1, 3, 1, 8) = I * c_array(1, 3, 0, 8);
        ...
        c_array(3, 3, 2, 0) = 2.0 * I * e_2 * tcos_x;
        p0 = d * h;
        p2 = e_2 * (0.625 + tcos_x);
        c_array(3, 3, 0, 1) = I * p0 * (0.625 - p2);
        c_array(3, 3, 1, 1) = -p0 * (0.625 + p2);
        c_array(3, 3, 2, 1) = -4.0 * I * e_2 * h2 * tcos_x;
        p0 = 0.0625 * d * h;
        p1 = -19.0 * I * h2 + d_2 * tan_x;
        p2 = e_2 * (d_2 * c_8_3i_tan + h2 * (19.0 + 28.0 * tcos_x));
        c_array(3, 3, 0, 2) = p0 * (p1 + I * p2);
        c_array(3, 3, 1, 2) = p0 * (I * p1 + p2);
        c_array(3, 3, 2, 2) = 2.0 * I * e_2 * h4 * tcos_x;
        p0 = 0.1875 * d * h3;
        p1 = 3.0 * I * h2 - d_2 * tan_x;
        p2 = e_2 * (d_2 * c_8_3i_tan + h2 * c_3_4tcos);
        c_array(3, 3, 0, 3) = p0 * (p1 - I * p2);
        c_array(3, 3, 1, 3) = p0 * (I * p1 - p2);
        p0 = h * e;
        c_array(3, 3, 0, 5) = p0 * (-0.5 * e_2 + 1.5);
        c_array(3, 3, 1, 5) = I * p0 * (0.5 * e_2 + 1.5);
        c_array(3, 3, 2, 5) = d * e;
        p1 = d_2 + 12.0 * h2;
        p2 = e_2 * (3.0 * d_2 + 4.0 * h2);
        c_array(3, 3, 0, 6) = p0 * (p1 - p2);
        c_array(3, 3, 1, 6) = I * p0 * (p1 + p2);
        c_array(3, 3, 2, 6) = -4.0 * h2 * d * e;
        p1 = -0.25 * d_4 + 3.5 * d_2 * h2 + 9.75 * h4;
        p2 = e_2 * (1.25 * d_4 + 10.5 * d_2 * h2 + 3.25 * h4);
        c_array(3, 3, 0, 7) = p0 * (p1 - p2);
        c_array(3, 3, 1, 7) = I * p0 * (p1 + p2);
        c_array(3, 3, 2, 7) = -4.0 * h4 * d * e;
        p0 = h3 * e * c_d_h;
        p1 = 0.5 * c_d_m3h;
        p2 = e_2 * (2.5 * d_2 + 0.5 * h2);
        c_array(3, 3, 0, 8) = -p0 * (p1 + p2);
        c_array(3, 3, 1, 8) = I * p0 * (-p1 + p2);
...
// an edge line or a vertex of the element
    ...
    il::StaticArray4D<std::complex<double>, 6, 4, 3, 5> s_ij_red_h
        ...
        c_array(1, 0, 0, 0) = -0.5 * I * c_1_nu * e2x * sgh;
        c_array(1, 0, 1, 0) = -0.5 * c_1_nu * e2x * sgh;
        c_array(1, 0, 2, 1) = 0.5 * I * c_1_2nu * eix;
        c_array(1, 0, 2, 2) = 2.0 * I * c_2_nu * h2 * eix;
        c_array(1, 0, 2, 3) = 2.0 * I * h4 * eix;
        ...
        c_array(3, 0, 2, 0) = -2.0 * I * c_1_nu * e2x * abh;
        c_array(3, 0, 0, 1) = -I * p1 * c_eix_3_1;
        c_array(3, 0, 1, 1) = p1 * c_eix_3_m1;
        c_array(3, 0, 0, 2) = -I * p2 * c_eix_3_1;
        c_array(3, 0, 1, 2) = p2 * c_eix_3_m1;
        c_array(3, 0, 0, 3) = -I * p3 * c_eix_3_1;
        c_array(3, 0, 1, 3) = p3 * c_eix_3_m1;
        c_array(3, 0, 0, 4) = -I * p4 / 3.0 * c_eix_3_1;
        ...
        c_array(0, 1, 2, 0) = -I * nu * e2x / abh;
        c_array(0, 1, 0, 2) = 0.5 * I * h * (3.0 * c_eix_3_1 - 4.0 * nu * eix);
        c_array(0, 1, 1, 2) = -0.5 * h * (3.0 * c_eix_3_m1 - 4.0 * nu * eix);
        c_array(0, 1, 0, 3) = 1.5 * I * h3 * c_eix_3_1;
        c_array(0, 1, 1, 3) = -1.5 * h3 * c_eix_3_m1;
        c_array(0, 1, 0, 4) = 0.25 * I * h5 * c_eix_3_1;
        ...
        c_array(1, 1, 0, 0) = -I * sgh * e2x * (c_1_mnu + 0.5 * e2x);
        ...
        c_array(2, 1, 0, 0) = I * c_array(2, 1, 1, 0);
        ...
        c_array(3, 1, 2, 0) = -2.0 * I * c_1_mnu * abh * e2x * e2x;
        c_array(3, 1, 0, 1) = -I * e2x * p1 * (c_5_m4nu + 3.0 * e2x);
        c_array(3, 1, 0, 2) = -I * e2x * p2 * (c_15_m8nu + 9.0 * e2x);
        c_array(3, 1, 0, 3) = -I * e2x * p3 * (c_15_m4nu + 9.0 * e2x);
        c_array(3, 1, 0, 4) = -I * e2x * p4 * (5.0 / 3.0 + e2x);
        ...
        c_array(5, 1, 2, 0) = -4.0 * I * c_1_mnu * abh * e2x;
        c_array(5, 1, 0, 1) = -I * p1 * (3.0 * c_5_m4nu + 5.0 * e2x);
        c_array(5, 1, 0, 2) = -3.0 * I * p2 * (c_15_m8nu + 5.0 * e2x);
        c_array(5, 1, 0, 3) = -3.0 * I * p3 * (c_15_m4nu + 5.0 * e2x);
        c_array(5, 1, 0, 4) = -5.0 * I * p4 * (1.0 + e2x / 3.0);
        ...
        c_array(4, 1, 0, 1) = 3.0 * I * p1 * (c_5_m4nu - 5.0 * e2x);
        ...
        c_array(4, 1, 0, 2) = 3.0 * I * p2 * (c_15_m8nu - 15.0 * e2x);
        ...
        c_array(4, 1, 0, 3) = 3.0 * I * p3 * (c_15_m4nu - 15.0 * e2x);
        ...
        c_array(0, 2, 0, 0) = I * c_array(0, 2, 1, 0);
        c_array(0, 2, 2, 2) = -I * h * eix;
        c_array(0, 2, 2, 3) = -2.0 * I * h3 * eix;
        ...
        c_array(1, 2, 0, 1) = 0.25 * I * eix * (c_2_mnu + nu * e2x);
        c_array(1, 2, 1, 1) = -0.25 * eix * (c_2_mnu - nu * e2x);
        c_array(1, 2, 0, 2) = 0.5 * I * h2 * eix * (c_5_mnu + c_3_nu * e2x);
        c_array(1, 2, 1, 2) = -0.5 * h2 * eix * (c_5_mnu - c_3_nu * e2x);
        c_array(1, 2, 0, 3) = 0.125 * I * h4 * eix * (8.0 + c_12_nu * e2x);
        c_array(1, 2, 1, 3) = -0.125 * h4 * eix * (8.0 - c_12_nu * e2x);
        c_array(1, 2, 1, 4) = 0.25 * h6 * e3x;
        c_array(1, 2, 0, 4) = I * c_array(1, 2, 1, 4);

        c_array(2, 2, 0, 1) = std::conj(c_array(1, 2, 0, 1) - I * p1);
        c_array(2, 2, 1, 1) = std::conj(p1 - c_array(1, 2, 1, 1));
        c_array(2, 2, 0, 2) = std::conj(c_array(1, 2, 0, 2) - I * p2);
        c_array(2, 2, 1, 2) = std::conj(p2 - c_array(1, 2, 1, 2));
        c_array(2, 2, 0, 3) = std::conj(c_array(1, 2, 0, 3) - I * p3);
        c_array(2, 2, 1, 3) = std::conj(p3 - c_array(1, 2, 1, 3));
        c_array(2, 2, 1, 4) = 0.75 * eix * h6;
        c_array(2, 2, 0, 4) = I * c_array(2, 2, 1, 4);
        ...
        c_array(3, 2, 0, 0) = -0.5 * I * (c_3_mnu + c_1_nu * e2x) * abh * e2x;
        ...
        c_array(1, 3, 2, 1) = I * eix;
        c_array(1, 3, 2, 2) = -4.0 * I * h2 * eix;
        c_array(1, 3, 2, 3) = -4.0 * I * h4 * eix;

        for (int j = 1; j < c_array.size(3) - 1; ++j) {
            c_array(2, 3, 2, j) = std::conj(c_array(1, 3, 2, j));
        }

        c_array(3, 3, 0, 1) = 0.5 * I * h * c_eix_3_1;
        c_array(3, 3, 1, 1) = -0.5 * h * c_eix_3_m1;
        c_array(3, 3, 0, 2) = 4.0 * I * h3 * c_eix_3_1;
        c_array(3, 3, 1, 2) = -4.0 * h3 * c_eix_3_m1;
        c_array(3, 3, 0, 3) = 3.25 * I * h5 * c_eix_3_1;
        c_array(3, 3, 1, 3) = -3.25 * h5 * c_eix_3_m1;
        c_array(3, 3, 0, 4) = 0.5 * I * h7 * c_eix_3_1;
...
// Limit case (h==0, plane) - all stress components
    ...
    il::StaticArray3D<std::complex<double>, 6, 4, 3> s_ij_lim_h
        ...
        v1[1] = h0_lim * e;
        v1[2] = std::conj(v1[1]);
        v1[3] = d * e * (h0_lim + 2.0 * I * eix);
        v1[4] = std::conj(v1[3]);
        v1[5] = -h0_lim * d_1;

        v2[0] = 0.5 * e_2 / d_1 * (sin_x - 2.0 * I * eix * cos_x * cos_x);
        v2[1] = -0.125 * e_3 * (4.0 * h0_lim + I * eix * (e2x + 8.0));
        v2[2] = 0.125 * e * (12.0 * h0_lim + 5.0 * I * eix);
        v2[3] = -0.5 * e_4 * d_1 * (3.0 * h0_lim - 2.0 * I * eix * (e2x - 3.0));
        v2[4] = -1.5 * d_1 * h0_lim;
        v2[5] = 1.5 * e_2 * d_1 * (h0_lim + 2.0 * I * eix);
